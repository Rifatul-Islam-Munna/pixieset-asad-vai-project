...
import { AdminPayPalSetting, AdminPayPalSettingSchema } from './entities/admin-paypal-setting.entity';
...
@Module({
  imports: [
    MongooseModule.forFeature([
      ...
      { name: AdminPayPalSetting.name, schema: AdminPayPalSettingSchema },
