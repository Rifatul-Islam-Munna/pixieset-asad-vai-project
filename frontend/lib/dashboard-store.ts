...
const defaultPresetItems: PresetItem[] = [
  ...
  {
    id: "builtin-wedding-gallery",
    name: "Wedding Gallery",
    general: { ...emptyPresetGeneral, collectionTags: "Wedding", photoSets: "Preview, Ceremony, Family, Couple Portraits, Reception", emailRegistration: true },
    design: { ...emptyPresetDesign, cover: "Center", typography: "Classic", color: "White", gridStyle: "Vertical", gridSpacing: "Regular" },
    download: { ...emptyPresetDownload, downloadPin: true, restrictDownloads: true },
    favorite: { ...emptyPresetFavorite, description: "Choose favorite images for the final album." },
    store: { ...emptyPresetStore, storeStatus: true, productPreview: true },
    updatedAt: "Built in",
  },
  {
    id: "builtin-portrait-proofing",
    name: "Portrait Proofing",
    general: { ...emptyPresetGeneral, collectionTags: "Portrait", photoSets: "Proofs, Retouched, Favorites", emailRegistration: true, socialSharing: false },
    design: { ...emptyPresetDesign, cover: "Left", typography: "Modern", color: "White", gridStyle: "Vertical", thumbnailSize: "Large" },
    download: { ...emptyPresetDownload, galleryDownload: false, highResolution: false, downloadPin: true, limitDownloads: true, limitPinUsage: "25" },
    favorite: { ...emptyPresetFavorite, maxFavorites: "20", description: "Select images for retouching." },
    store: { ...emptyPresetStore, storeStatus: true, productPreview: true },
    updatedAt: "Built in",
  },
  {
  ...
  {
    id: "builtin-commercial-product",
    name: "Commercial Product",
    general: { ...emptyPresetGeneral, collectionTags: "Commercial", photoSets: "Selects, Final Edits, Usage Approved", emailRegistration: true, socialSharing: false },
    design: { ...emptyPresetDesign, cover: "Left", typography: "Modern", color: "White", gridStyle: "Horizontal", thumbnailSize: "Large" },
    download: { ...emptyPresetDownload, highResolutionSize: "Original", downloadPin: true, restrictDownloads: true },
    favorite: { ...emptyPresetFavorite, favoriteNotes: true, description: "Leave usage notes and selects." },
    store: { ...emptyPresetStore, storeStatus: false },
    updatedAt: "Built in",
  },
];
